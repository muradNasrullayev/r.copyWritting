...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Advantages</h1>

</div>
<a type="button" class="btn btn-success" href="{{route('admin.advantages.create')}}">Add new item</a>
<!-- /.container-fluid -->
    ...
    <tr>
        ...
        <td>
            <div class="btn-group" role="group" style="gap: 2px;">
                ...
                <a href="{{route('admin.advantages.show',$advantage->id)}}" class="btn btn-primary mt-3">
                ...
                <form action="{{route('admin.advantages.destroy',$advantage->id)}}"
                      method="POST">
                    @csrf
                    @method('DELETE')
