...
<table class="table">
    ...
    <tr>
        ...
        <td><img src="{{asset($welcome->background_image)}}" width="150px" height="100px"></td>
        <td>
            <div class="btn-group" role="group" style="gap: 2px;">
                <a href="{{ route('admin.welcomepage.edit', $welcome->id)}}"
                   class="btn btn-warning mt-3">Edit</a> <br>
                <a href="{{route('admin.welcomepage.show',$welcome->id)}}" class="btn btn-primary mt-3">
